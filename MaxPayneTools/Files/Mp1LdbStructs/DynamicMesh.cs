...
public class DynamicMesh : Readable {
    ...
    public DynamicMesh(BinaryReader br) : base(br) {
        ...
        var normalCount = br.ReadSpecificDataType<DataTypeInt>().Value;
        ...
        var radCount = br.ReadSpecificDataType<DataTypeInt>().Value;
        ...
        var animCount = br.ReadSpecificDataType<DataTypeInt>().Value;
