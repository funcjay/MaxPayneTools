...
public class MaterialContainer : Readable {
    ...
    public MaterialContainer(BinaryReader br) : base(br) {
        // Textures
        var texCount = br.Read<DataTypeInt>().Value;
        ...
        var catCount = br.Read<DataTypeInt>().Value;
